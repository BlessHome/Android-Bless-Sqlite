 ...
 * <br>级联操作：该对象数据，及其关系、和关联对象都被处理
 */
final class CascadeSQLiteImpl extends SQLite {

    public static final String TAG = CascadeSQLiteImpl.class.getSimpleName();

    protected CascadeSQLiteImpl(SQLite dataBase) {
        super(dataBase);
    }

    protected CascadeSQLiteImpl(DataBaseConfig config) {
        super(config);
    }
